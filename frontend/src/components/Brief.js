        ...
        <div class="brief-body ind-comp-body center">
            <div class="brief-card" id="c1">
                ...
                <div class="brief-card-content">
                    ...
                    <button><a href="https://apiumhub.com/tech-blog-barcelona/innovation-blogs/"  target="_blank" rel="noopener noreferrer">Know More</a></button>
                </div>
            </div>
            <div class="brief-card" id="c2">
                ...
                <div class="brief-card-content">
                    ...
                    <button><a href="https://www.mckinsey.com/capabilities/sustainability/our-insights/sustainability-blog" target="_blank" rel="noopener noreferrer">Know More</a></button>
                </div>
            </div>
            <div class="brief-card" id="c3">
                ...
                <div class="brief-card-content">
                    ...
                    <button><a href="https://www.greenmatch.co.uk/blog/how-to-be-more-eco-friendly" target="_blank" rel="noopener noreferrer">Know More</a></button>
                </div>
            </div>
        </div>
    </div>
